...
const ProductCard: FC<ProductProps> = ({
	...
	return (
		<div
			className={cn(
				"group box-border overflow-hidden flex rounded-md cursor-pointer text-secondary",
				{
					"pe-0 pb-2 lg:pb-3 flex-col items-start bg-base-200 transition duration-200 ease-in-out transform hover:-translate-y-1 hover:md:-translate-y-1.5 hover:shadow-product":
						variant === "grid",
					"pe-0 md:pb-1 flex-col items-start bg-base-200": variant === "gridSlim",
					"items-center bg-transparent border transition duration-200 ease-in-out transform hover:-translate-y-1 hover:shadow-listProduct":
						variant === "listSmall",
					"flex-row items-center transition-transform ease-linear bg-base-200 pe-2 lg:pe-3 2xl:pe-4":
						variant === "list",
				},
				className
			)}
		...
		>
			...
			>
				...
				<div
					className={`font-text font-semibold text-sm sm:text-base mt-1.5 space-s-2 ${
						variant === "grid"
